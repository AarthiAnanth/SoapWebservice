 ...
 * 2020-03-30T15:47:50.103+05:30
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "PaymentProcessorImplService", 
                  wsdlLocation = "classpath:PaymentProcessorImpl.wsdl",
...
public class PaymentProcessorImplService extends Service {
    ...
    static {
        URL url = PaymentProcessorImplService.class.getClassLoader().getResource("PaymentProcessorImpl.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(PaymentProcessorImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "classpath:PaymentProcessorImpl.wsdl");
        }       
        WSDL_LOCATION = url;   
    }
