...
public interface CustomerOrdersPortType {
    ...
    @WebMethod
    @WebResult(name = "deleteOrderResponse", targetNamespace = "http://trainings.ws.bharath.com/", partName = "parameters")
    public DeleteOrderResponse deleteOrders(
        @WebParam(partName = "parameters", name = "deleteOrderRequest", targetNamespace = "http://trainings.ws.bharath.com/")
